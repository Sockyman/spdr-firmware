...
private:
    ...
    MicroSequence& instructionAluBinaryDirect(std::string name, bool swapA, bool keepResult, Line aluLine, FlagSet carrySet);
    MicroSequence& instructionAluBinaryImm(std::string name, bool swapA, bool keepResult, Line aluLine, FlagSet carrySet);
    void instructionAluBinary(std::string name, bool swapA, bool keepResult, Line aluLine, FlagSet carrySet);
    MicroSequence& instructionAluUnary(std::string name, RID reg, Line aluLine, FlagSet carrySet);
    MicroSequence& instructionAluUnaryMem(std::string name, Line aluLine, FlagSet carrySet);
    MicroSequence& instructionAluUnaryIndirect(std::string name, Line aluLine, FlagSet carrySet);
